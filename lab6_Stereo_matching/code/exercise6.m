...
% mex -setup C++
% mex -setup C
% run('/Users/kerry/Documents/study/CV/exercise/Lab Assignment - Stereo Matching-20201110/code/GCMex-master/compile_gc.m')% Should you have any problems compiling them under Linux, Windows, Mac, 
...
%     Method 2: using sift features
    ...
    [fa, da] = vl_sift(img1); % keypoints and descriptors 
    [fb, db] = vl_sift(img2);
